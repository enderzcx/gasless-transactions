...
| --------- | --------- | -------- | -------- | -------- | ---- | -------- |
| test | [@DrakenZeng](https://github.com/DrakenZeng) | Telegram: @username，微信: username，邮箱: email@example.com_ | No | LLM 应用赛道 | No | [Link](https://github.com/CasualHackathon/SPARK-AI-Hackathon/issues/38) |
